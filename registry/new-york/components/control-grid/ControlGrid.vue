...
// Utiliser le composable de drag and drop
const {
...
// Adapter le dragState pour la compatibilité avec GridItem
...
// Drag and Drop handlers utilisant le composable
...
const handleDragOver = (event: DragEvent) => {
  // Utiliser le composable pour gérer le drag over
  ...
  // Mettre à jour hoverCell avec la position calculée
  hoverCell.value = pos;

  // Gérer previewSize pour les items externes
