...
:::code-tree{default-value="src/components/ui/use-control-registry/index.ts"}

```ts [src/components/ui/use-control-registry/index.ts]
...
```ts [src/components/ui/use-control-registry/use-control-registry.ts]
export * from "./index";
export { useControlRegistry as default } from "./index";
```
:::
