...
## Getting Started with Assembler UI
...
Great job! Your project is now configured to use Assembler UI.
::
::

### Optional: Add Icon Support

A variety of Assembler UI components and demos utilize the `<Icon>` component with Iconify icons. Although optional, we recommend installing it for an optimal experience.
...
### Start Using Assembler UI 🚀

Now, you can start using Assembler UI components in your project. Choose the components you need, copy the code, and integrate them into your application.
